...
export const CreateIconOutline = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const HeartIcon = ({ size, fill }) => (
  <motion.div
    key={fill}
    initial={{ opacity: 0, fill: "none", scale: fill ? 0 : 1 }}
    animate={{
      opacity: 1,
...
export const LanguageIcon = ({ size }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
